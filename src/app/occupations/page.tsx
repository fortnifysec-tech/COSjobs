...
export default async function OccupationsPage() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 md:py-10">
      ...
      <section className="mt-12" aria-labelledby="eligible">
        <h2 id="eligible" className="text-[1.25rem]">
          Eligible codes with no live roles today
        </h2>
      ...
      <section className="mt-12" aria-labelledby="ineligible">
        <h2 id="ineligible" className="text-[1.25rem]">
          Codes below RQF 6 and not on a shortage list
        </h2>
        <p className="mt-1 text-[0.9375rem] text-ink-70">
